        ...
        return (
            <div>
                ...
                >
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <p className="calculation1">
                                            <span className="power">Attack Power</span>
                                            <span className="plus">+</span>
                                            <span className="bonus">Elemental Compatibility Bonus</span>
                                        </p>
                    ...
                    <div onClick={this.closeModal} onKeyPress={this.closeModal} role="utton" tabIndex="0"><i className="ButtonClose">Close</i></div>
                </Modal>
            </div>
        );
    }
